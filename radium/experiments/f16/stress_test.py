...
from radium.systems.f16.simulator import (
    ResidualControl,
...
"""
CUDA_VISIBLE_DEVICES=2, XLA_PYTHON_CLIENT_MEM_FRACTION=0.2 python radium/experiments/f16/stress_test.py --file_prefix results/f16_ep_1e-4/L_1.0e+00/500_samples/0_quench/tempered10_chains/dp_1.0e-02/ep_1.0e-04/repair/predict/mala &
CUDA_VISIBLE_DEVICES=2, XLA_PYTHON_CLIENT_MEM_FRACTION=0.2 python radium/experiments/f16/stress_test.py --file_prefix results/f16_ep_1e-4/L_1.0e+00/500_samples/0_quench/tempered10_chains/dp_1.0e-02/ep_1.0e-04/repair/predict/gd &
CUDA_VISIBLE_DEVICES=3, XLA_PYTHON_CLIENT_MEM_FRACTION=0.2 python radium/experiments/f16/stress_test.py --file_prefix results/f16_ep_1e-4/L_1.0e+00/500_samples/0_quench/tempered10_chains/dp_1.0e-02/ep_1.0e-04/repair/predict/reinforce &
CUDA_VISIBLE_DEVICES=3, XLA_PYTHON_CLIENT_MEM_FRACTION=0.2 python radium/experiments/f16/stress_test.py --file_prefix results/f16_ep_1e-4/L_1.0e+00/500_samples/0_quench/tempered10_chains/dp_1.0e-02/ep_1.0e-04/repair/predict/rmh &
CUDA_VISIBLE_DEVICES=3, XLA_PYTHON_CLIENT_MEM_FRACTION=0.2 python radium/experiments/f16/stress_test.py --file_prefix results/f16_ep_1e-4/L_1.0e+00/500_samples/0_quench/tempered10_chains/dp_1.0e-02/ep_1.0e-04/repair/no_predict/gd &
"""
